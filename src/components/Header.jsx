...
const Header = () => {
  ...
  return (<div className="flex justify-between duration-1000  dark:bg-gray-900 bg-slate-100  shadow-md  mb-0 static  top-0">
    ...
    <div className=" m-5 duration-1000  rounded-lg cursor-pointer" onClick={() => {
      ...
      {theme == "sunny" ? <button className={`leading-9 text-xl rounded-full m-2    ${theme === "moon" ? "text-sky-600" : "dark:text-white"}`}>
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-moon-filled" width="30" height="30" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          <path d="M12 1.992a10 10 0 1 0 9.236 13.838c.341 -.82 -.476 -1.644 -1.298 -1.31a6.5 6.5 0 0 1 -6.864 -10.787l.077 -.08c.551 -.63 .113 -1.653 -.758 -1.653h-.266l-.068 -.006l-.06 -.002z" stroke-width="0" fill="currentColor" />
        </svg>
      </button> : <button
        className={`leading-9 text-xl rounded-full m-2  ${theme === "sunny" ? "text-sky-600" : "dark:text-white"}`}>
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-sun-filled" width="30" height="30" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
